    ...
    public class PasswordChecker
    {
        ...
        internal static bool CheckPassword(string password, out string error, string passwordsJson = "")
        {
            ...
            if (complexPassword)
            {
                ...
                if (countArr.Sum() < 3)
                {
                    error = ($"Your password must include characters from at least three of the following four categories: uppercase letters, lowercase letters, numbers, and special characters.");
                    return false;
                }
            }
